...
class PlayState extends MusicBeatState
{
	...
	public static var ghostTap = false;
	...
	public var mechanicsEnabled:Bool = true;
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBar.y + 45, FlxG.width - 800, "[ BOTPLAY ]", 38);
	...
	function startSong():Void
	{
		...
		maxmissesTxt = new FlxText(400, timeBar.y + 45, FlxG.width - 800, 'Max misses: 5', 32);
		maxmissesTxt.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		maxmissesTxt.scrollFactor.set();
		maxmissesTxt.borderSize = 1.25;
		maxmissesTxt.alpha = 1;
		uiGroup.add(maxmissesTxt);

		FlxTween.tween(maxmissesTxt, {alpha: 0}, 0.7, {ease: FlxEase.quartInOut, startDelay: 5.4});
	...
	override public function update(elapsed:Float)
	{
		...
		// SPACE
		//if (controls.justPressed("SPACE")) // HOW TO MADE THIS MECANICCC
		//{
		...
		if (generatedMusic)
		{
			...
			{
				if(!cpuControlled)
					keysCheck(); // chek far kes again bp
				else
					playerDance();
			...
			case 'Hey!':
				...
				if(value != 0) {
					if(dad.curCharacter.startsWith('gf')) { //Tutorial GF is actually Dad! The GF is an imposter!! ding ding ding ding ding ding ding, dindinding, end my suffering
						dad.playAnim('cheer', true); // What the fuck ^^^^
